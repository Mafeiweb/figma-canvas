...
var require_Enhance = __commonJS({
  "node_modules/konva/lib/filters/Enhance.js"(exports) {
    ...
    var Enhance = function(imageData) {
      ...
      let rMin = data[0], rMax = rMin, r, gMin = data[1], gMax = gMin, g2, bMin = data[2], bMax = bMin, b2;
  ...
  "node_modules/konva/lib/filters/HSL.js"(exports) {
    ...
    var HSL = function(imageData) {
      ...
      for (let i = 0; i < nPixels; i += 4) {
        ...
        b2 = data[i + 2];
        a = data[i + 3];
        data[i + 0] = rr * r + rg * g2 + rb * b2 + l;
        data[i + 1] = gr * r + gg * g2 + gb * b2 + l;
        data[i + 2] = br * r + bg * g2 + bb * b2 + l;
        data[i + 3] = a;
      }
    };
    exports.HSL = HSL;
  ...
  "node_modules/konva/lib/filters/HSV.js"(exports) {
    ...
    var HSV = function(imageData) {
      ...
      for (let i = 0; i < nPixels; i += 4) {
        ...
        const b2 = data[i + 2];
        const a = data[i + 3];
        data[i + 0] = rr * r + rg * g2 + rb * b2;
        data[i + 1] = gr * r + gg * g2 + gb * b2;
        data[i + 2] = br * r + bg * g2 + bb * b2;
        data[i + 3] = a;
      }
    };
    exports.HSV = HSV;
...
var require_Kaleidoscope = __commonJS({
  "node_modules/konva/lib/filters/Kaleidoscope.js"(exports) {
    ...
    var Kaleidoscope = function(imageData) {
      ...
      let x, y2, xoff, i, r, g2, b2, a, srcPos, dstPos;
  ...
  "node_modules/konva/lib/filters/Sepia.js"(exports) {
    ...
    var Sepia = function(imageData) {
      ...
      for (let i = 0; i < nPixels; i += 4) {
        ...
        const g2 = data[i + 1];
        const b2 = data[i + 2];
        data[i + 0] = Math.min(255, r * 0.393 + g2 * 0.769 + b2 * 0.189);
        data[i + 1] = Math.min(255, r * 0.349 + g2 * 0.686 + b2 * 0.168);
        data[i + 2] = Math.min(255, r * 0.272 + g2 * 0.534 + b2 * 0.131);
      }
    };
    exports.Sepia = Sepia;
  }
...
var S = { key: true, style: true, elm: true, isRootInsert: true };
...
function L(a, o, i, e) {
  ...
  for (let t in i) {
    ...
    if (s && d) {
      ...
      l.slice(0, 7) === "content" && (l = "content" + l.slice(7, 1).toUpperCase() + l.slice(8)), n == null ? void 0 : n.off(l + y, i[t]);
    }
    !o.hasOwnProperty(t) && (n == null ? void 0 : n.setAttr(t, void 0));
  }
  for (let t in o) {
    if (S.hasOwnProperty(t))
      continue;
    ...
    if (s && d) {
      ...
      c.slice(0, 7) === "content" && (c = "content" + c.slice(7, 1).toUpperCase() + c.slice(8)), o[t] && (n == null ? void 0 : n.off(c + y), n == null ? void 0 : n.on(c + y, o[t]));
    }
    !s && (o[t] !== i[t] || e && o[t] !== (n == null ? void 0 : n.getAttr(t))) && (r = true, u[t] = o[t]);
  }
...
function U(a) {
  function o(i) {
    return (i == null ? void 0 : i.__konvaNode) ? i : (i == null ? void 0 : i.parent) ? o(i.parent) : (console.error("vue-konva error: Can not find parent node"), null);
  }
  return o(a.parent);
}
function b(a) {
...
function j(a) {
  ...
  if ((o == null ? void 0 : o.tagName) && i && !e) {
...
function O(a, o) {
  ...
  let n = false;
  e.forEach((u, r) => {
    u.getZIndex() !== r && (u.setZIndex(r), n = true);
  }), n && p(o);
}
var _a;
var $ = ((_a = import_konva.default.default) == null ? void 0 : _a.Stage) || import_konva.default.Stage;
var F = defineComponent({
  ...
  setup(a, { attrs: o, slots: i, expose: e }) {
    ...
    if (!n)
      return;
    const u = reactive({}), r = ref(null), t = new $({
    ...
    return onMounted(() => {
      ...
      t.destroy();
    }), watch(() => a.config, c, { deep: true }), e({
      getStage: d,
      getNode: s
    }), () => {
      var _a2;
      return h("div", { ref: r, style: o == null ? void 0 : o.style }, (_a2 = i.default) == null ? void 0 : _a2.call(i));
    };
  }
});
...
function W(a, o) {
  return defineComponent({
    ...
    setup(i, { attrs: e, slots: n, expose: u }) {
      ...
      onMounted(() => {
        var _a2;
        const f = (_a2 = U(r)) == null ? void 0 : _a2.__konvaNode;
        f && "add" in f && f.add(s), p(s);
      }), onUnmounted(() => {
        p(s), s.destroy(), s.off(G);
      }), onUpdated(() => {
        l(), O(r.subTree, s);
      }), watch(() => i.config, l, { deep: true }), u({
        getStage: c,
        getNode: d
      });
      ...
      return () => {
        var _a2;
        return v ? h("template", {}, (_a2 = n.default) == null ? void 0 : _a2.call(n)) : null;
      };
    }
  });
}
function Z(a, o, i) {
  const e = ref(null), n = ref("loading"), u = (t, s, d) => {
    n.value = "loading";
    const c = new Image();
    ...
    url: toValue(a),
    crossorigin: toValue(o),
    referrerPolicy: toValue(i)
  }));
  return watch(
    r,
...
var H = {
  install: (a, o) => {
    const i = (o == null ? void 0 : o.prefix) || I, e = import_konva.default.default || import_konva.default, n = {
      Arc: e.Arc,
      Arrow: e.Arrow,
      Circle: e.Circle,
      Ellipse: e.Ellipse,
